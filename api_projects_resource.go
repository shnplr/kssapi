...
func (r ApiApisProjectV1ProjectsPostRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *ProjectsResourceApiService) ApisProjectV1ProjectsPostExecute(r ApiApisProjectV1ProjectsPostRequest) (*http.Response, error) {
	var (
