...
type ApiApisUserV1UsersGet_0Request struct {
	ctx context.Context
	ApiService *UserGroupsResourceApiService
}

func (r ApiApisUserV1UsersGet_0Request) Execute() (*User, *http.Response, error) {
	return r.ApiService.ApisUserV1UsersGet_1Execute(r)
}

/*
ApisUserV1UsersGet_0 Method for ApisUserV1UsersGet_0

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApisUserV1UsersGet_0Request
*/
func (a *UserGroupsResourceApiService) ApisUserV1UsersGet_1(ctx context.Context) ApiApisUserV1UsersGet_0Request {
	return ApiApisUserV1UsersGet_0Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return User
func (a *UserGroupsResourceApiService) ApisUserV1UsersGet_1Execute(r ApiApisUserV1UsersGet_0Request) (*User, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserGroupsResourceApiService.ApisUserV1UsersGet_1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
