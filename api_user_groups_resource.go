...
func (r ApiApisUserV1UsersGetRequest) Execute() (*User, *http.Response, error) {
...
// Execute executes the request
//  @return User
func (a *UserGroupsResourceApiService) ApisUserV1UsersGetExecute(r ApiApisUserV1UsersGetRequest) (*User, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
