...
type ObjectMeta struct {
	...
	ObjectMeta *IObject `json:"objectMeta,omitempty"`
}
...
// GetObjectMeta returns the ObjectMeta field value if set, zero value otherwise.
...
// SetObjectMeta gets a reference to the given IObject and assigns it to the ObjectMeta field.
